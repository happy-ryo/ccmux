...
> **これは [Shin-sibainu/ccmux](https://github.com/Shin-sibainu/ccmux) のフォークです。** 上流を定期的に取り込みつつ、独自機能を先行して足しています。npm では別パッケージ `@suisya-systems/renga` (旧 `ccmux-fork`) として配布しています。ブランチの使い分けは [`BRANCHING.md`](./BRANCHING.md) を参照してください。
